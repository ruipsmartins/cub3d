...
SRCS_DIR = src
SRCS_FILES = main.c init_game.c clean_game.c player_move.c open_map.c texture.c rgb.c map.c \
raycasting.c utils.c player_utils.c raycasting_utils.c minimap.c\
